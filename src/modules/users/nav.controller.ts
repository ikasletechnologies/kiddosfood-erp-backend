      ...
      menu.push({
        ...
        children: [
          ...
          },
          {
            ...
            path: '/reports?parent=franchise',
            children: [
              { title: 'Franchise Performance', path: '/reports?parent=franchise&report=Franchise+Performance+Summary' },
              { title: 'Franchise Outstanding', path: '/reports?parent=franchise&report=Franchise+Dues+%26+Balances' }
            ]
          }
        ]
      });
