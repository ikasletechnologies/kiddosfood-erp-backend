...
app.get('/api/purchase/rfqs', authenticate, authorizeRole(['FRANCHISE_ADMIN']), PurchaseController.getRFQs);
app.post('/api/purchase/rfqs', authenticate, authorizeRole(['FRANCHISE_ADMIN']), PurchaseController.createRFQ);
app.get('/api/purchase/rfqs/:id', authenticate, authorizeRole(['FRANCHISE_ADMIN']), PurchaseController.getRFQ);
app.patch('/api/purchase/rfqs/:id', authenticate, authorizeRole(['FRANCHISE_ADMIN']), PurchaseController.updateRFQ);
app.post('/api/purchase/rfqs/:id/convert-to-po', authenticate, authorizeRole(['FRANCHISE_ADMIN']), PurchaseController.convertRFQtoPO);
